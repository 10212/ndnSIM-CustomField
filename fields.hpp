...
typedef FieldDecl<field_location_tags::Header,
                  AdditionalField,
                  tlv::AdditionalField> AdditionalFieldField;
BOOST_CONCEPT_ASSERT((Field<AdditionalFieldField>));


typedef FieldDecl<field_location_tags::Header,
                  Position,
                  tlv::Position> ConsumerPositionField;
BOOST_CONCEPT_ASSERT((Field<ConsumerPositionField>));
...
typedef boost::mpl::set<
  ...
  HopCountTagField,
AdditionalFieldField,
  ConsumerPositionField
  > FieldSet;
